<?php
    ...
    function create_note($user_id, $note_title, $note_text) {
        global $pdo;
        $sql = "INSERT INTO note (user_id, note_title, note_text) VALUES (?, ?, ?)";
        $query = $pdo->prepare($sql);
        $query->bindParam(1, $user_id, PDO::PARAM_INT);
        $query->bindParam(2, $note_title, PDO::PARAM_STR);
        $query->bindParam(3, $note_text, PDO::PARAM_STR);
